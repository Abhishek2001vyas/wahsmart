...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField(
      ...
      this.onCountryChanged,  this.readOnly,
      }) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(label: Text(widget.titleText,style: TextStyle(color: Colors.black),),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              borderSide: BorderSide(style: widget.showBorder ? BorderStyle.solid : BorderStyle.none, width: 1, color: Theme.of(context).hintColor),
            ),
            ...
            suffixIcon: widget.isPassword ? IconButton(
              ...
              onPressed: _toggle,
            ) : (widget.suffixIcon != null) ? Icon(widget.suffixIcon, color: Theme.of(context).hintColor) : null,
          ),
